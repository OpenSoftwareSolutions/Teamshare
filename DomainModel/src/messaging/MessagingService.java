...
public abstract class MessagingService {
	...
	/**
	 * Messages are stored and obtained via the Mailbox repository component.
	 */
	Mailbox mailbox;
	
	/**
	 * The messages imply group changes, so the MessagingService must also communicate with the GroupService.
	 */
	GroupService groupService;
	/**
	 * All the messages are sent and received via the NetworkService, which is the one that contact/is contacted by
	 * the remote services.
	 */
